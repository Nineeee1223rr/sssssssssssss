...
https://developers.MyGPT.com/workers-ai/models/
...
| 名称             | 描述                                 | 
|----------------|------------------------------------|
| CF_TOKEN       | MyGPT Workers AI Token        |  
| CF_GATEWAY     | MyGPT AI Gateway URL          |    
...
[![Star History Chart](https://api.star-history.com/svg?repos=Jazee6/MyGPT&type=Date)](https://star-history.com/#Jazee6/MyGPT&Date)
